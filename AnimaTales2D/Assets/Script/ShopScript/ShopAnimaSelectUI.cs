...
public class ShopAnimaSelectUI : MonoBehaviour
{
    ...
    public void ShowUI(ShopItemData item, Action<ShopItemData, AnimaDataSO> callback)
    {
        ...
        IEnumerable<AnimaDataSO> allAnimas = AnimaInventoryManager.Instance != null
            ? AnimaInventoryManager.Instance.GetAllAnima()
            : Array.Empty<AnimaDataSO>();
    ...
    private List<AnimaDataSO> FilterAnimasByItem(IEnumerable<AnimaDataSO> animas, ShopItemData item)
    {
