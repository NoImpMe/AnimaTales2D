...
public class ShopUIManager : MonoBehaviour
{
    ...
    private readonly Dictionary<string, ShopItemSlot> activeSlots = new();
    ...
    public void ShowShopItems(List<ShopItemData> items, Dictionary<string, int> remainingCounts, Action<ShopItemData> onPurchase)
    {
        ...
        foreach (var item in items)
        {
            ...
            int remaining = remainingCounts.TryGetValue(item.itemID, out var count) ? count : item.maxPurchaseCount;
