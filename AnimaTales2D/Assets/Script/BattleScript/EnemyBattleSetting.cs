...
public class EnemyBattleSetting : MonoBehaviour, IEnemyBattleSetting
{
    ...
    public void SpawnTutorial()
    {
        ...
        if (enemyObjPrefab.Count == 1 && enemyObjPrefab != null && enemyHpPrefab != null)
        {
            ...
            int index = enemyInstance[0].name.IndexOf(CloneSuffix);
            ...
            index = enemyHpInstance[0].name.IndexOf(CloneSuffix);
            enemyHpInstance[0].name = enemyHpInstance[0].name.Substring(0, index) + 0;
            index = enemyInfoInstance[0].name.IndexOf(CloneSuffix);
            ...
            index = enemyParserInstance[0].name.IndexOf(CloneSuffix);
        ...
        int numberOfObjectsToAdd = Random.Range(1, 4);
            ...
            if (enemyObjPrefab.Count == 3 && enemyObjPrefab != null && enemyHpPrefab != null)
            {
                for (int i = 0; i < enemyObjPrefab.Count; i++)
                {
                    ...
                    int index = enemyInstance[i].name.IndexOf(CloneSuffix);
                    ...
                    index = enemyHpInstance[i].name.IndexOf(CloneSuffix);
                    enemyHpInstance[i].name = enemyHpInstance[i].name.Substring(0, index) + i;
                    index = enemyInfoInstance[i].name.IndexOf(CloneSuffix);
                    ...
                    index = enemyParserInstance[i].name.IndexOf(CloneSuffix);
    ...
    public void AmareSpawn(string charmedAnima)
    {
        ...
        int index = enemyInstance[1].name.IndexOf(CloneSuffix);
        ...
        index = enemyHpInstance[1].name.IndexOf(CloneSuffix);
        enemyHpInstance[1].name = enemyHpInstance[1].name.Substring(0, index) + "1";
        index = enemyInfoInstance[1].name.IndexOf(CloneSuffix);
        enemyInfoInstance[1].name = enemyInfoInstance[1].name.Substring(0, index);
        index = enemyParserInstance[1].name.IndexOf(CloneSuffix);
