...
public class CameraManager : MonoBehaviour
{
    ...
    ParticleSystem ps;
    GameObject prefab;
    private const string SkillResourcePath = "AnimaSkill/";
    ...
    public IEnumerator ZoomSingleOpp(Transform hitter,Transform hitted,  bool isAlly, string skill)
    {
        ...
        if (isAlly)
        {
            ...
            prefab = Resources.Load<GameObject>(SkillResourcePath + skill);
            ...
            yield return cameraDelay;
            prefab = Resources.Load<GameObject>(SkillResourcePath + skill + "ed");
