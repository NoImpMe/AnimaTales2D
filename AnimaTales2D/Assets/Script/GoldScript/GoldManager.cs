...
public class GoldManager : MonoBehaviour
{
    ...
    private const float SpendGoldAnimationDuration = 1f;
    ...
    public IEnumerator SpendGold(int amount)
    {
        ...
        while (elapsed < SpendGoldAnimationDuration)
        {
            elapsed += Time.deltaTime;
            float t = elapsed / SpendGoldAnimationDuration;
            float value = Mathf.Lerp(startGold, resultGold, t);
