...
public class TitleManager : MonoBehaviour
{
    ...
    public void TutorialClick()
    {
        ...
        gameManager.GetComponent<GoldManager>().Init();
        gameManager.GetComponent<AnimaInventoryManager>().playerInfo.TutorInitialize();
    ...
    public void OnNewGameClick()
    {
        ...
        GameObject gameManager = GameObject.Find("Game Manager");
        gameManager.GetComponent<GoldManager>().Init();
        gameManager.GetComponent<AnimaInventoryManager>().playerInfo.Initialize();
        SetButtonsInteractable(false);
        StartCoroutine(fadePanel.LoadSceneWithFade("Stage0Scene"));
    }
