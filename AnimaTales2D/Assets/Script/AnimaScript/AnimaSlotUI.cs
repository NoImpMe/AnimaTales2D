...
public class AnimaSlotUI : MonoBehaviour, IPointerClickHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IDropHandler
{
    ...
    private void UpdateUI()
    {
        ...
        if (animaData != null)
        {
            string imagePath = "Anima_Sprites/" + animaData.Objectfile;
            ...
            bool isDefeated = animaData.Animadie || animaData.Stamina <= 0;
            portraitImage.material = isDefeated ? grayscaleMaterial : null;
        }
        else
        {
