...
public class PlayerInfo : ScriptableObject
{
    ...
    // Index/location used for the first anima added during initialization; always 0.
    private const int InitialAnimaLocation = 0;
    ...
    public void Initialize()
    {
        ...
        animaData.location = InitialAnimaLocation;
        GetAnima(animaData);
        BattleSetting(haveAnima[InitialAnimaLocation]);
